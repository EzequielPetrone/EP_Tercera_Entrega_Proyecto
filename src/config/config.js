...
export { MONGO_URL, PORT, MODE, EXP_TIME, NUMCPUS, PASSPORT_SESSION_SECRET, TWILIO_ACCOUNT_SID, TWILIO_AUTH_TOKEN, TWILIO_FROM_NUMBER, MAIL_ADMIN, PHONE_NUMBER_ADMIN }